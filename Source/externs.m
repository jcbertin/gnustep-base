...
GSPrivateDispatchInitialize(void)
{
  ...
  void** dispatch_begin_thread_4GC = dlsym(RTLD_DEFAULT, "dispatch_begin_thread_4GC");
  if (NULL != dispatch_begin_thread_4GC)
	{
      *dispatch_begin_thread_4GC = (void*)GSRegisterThreadWithGC;
    }
#endif
}
